...
def _agy_read_grant(packet_name: str) -> str:
    ...
    return (
        ...
        "assert from a repo file. TOOL CONVENTION (an errored or denied "
        "tool step voids your whole review, so follow it exactly): to "
        "SEARCH, use your grep_search tool — never a shell command — and "
        "set its SearchPath to a SPECIFIC subdirectory of the repo (for "
